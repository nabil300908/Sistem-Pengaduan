...
Route::middleware('auth.role:admin')
    ...
    ->group(function () {
        ...
        Route::get('/laporan', [AdminController::class, 'index'])
            ->name('laporan.index');

        Route::get('/laporan/{id}', [AdminController::class, 'show'])
            ->name('laporan.show');

        Route::patch('/laporan/{id}/status', [AdminController::class, 'updateStatus'])
            ->name('laporan.status');
