            ...
            <div class="col-12 col-sm-10 col-md-7 col-lg-5 col-xl-4">
                ...
                <div class="card border-0 shadow-lg rounded-4">
                    <div class="card-body p-4">
                        <h5 class="fw-bold mb-1 text-center">Login Admin</h5>
                        <p class="text-muted text-center mb-4 small">Masuk sebagai administrator</p>
                        ...
                        @endif
                        @if(session('success'))
                            <div class="alert alert-success rounded-3 d-flex align-items-center gap-2 py-2">
